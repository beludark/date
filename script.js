...
ouiButton.addEventListener("click", () => {
  // Efface tout le contenu de la page et affiche un formulaire
  document.body.innerHTML = `
    <h1>J'étais sûr que tu allais dire oui !</h1>
  ...
  // Ajouter des styles au formulaire
  ...
  document.getElementById("submitDispo").addEventListener("click", () => {
    ...
    if (dispo) {
      ...
      emailjs.send("service_rsi6fy4", "template_1fqr5xj", {
        to_name: "Gabriel",
